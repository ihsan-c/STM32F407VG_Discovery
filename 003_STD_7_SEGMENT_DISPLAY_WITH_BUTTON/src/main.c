	...
	switch(count)
		{
			...
			case 1 :
			{
				...
				GPIO_ResetBits(GPIOA,GPIO_Pin_0|GPIO_Pin_5|GPIO_Pin_3|GPIO_Pin_4|GPIO_Pin_6);
					break ;
			}
			case 2 :
			{
			...
			case 4 :
			{
				GPIO_SetBits(GPIOA,GPIO_Pin_1|GPIO_Pin_2|GPIO_Pin_6|GPIO_Pin_5);
			...
			case 5 :
			{
				...
				GPIO_Pin_3|GPIO_Pin_6|GPIO_Pin_5);
		...
		case 8 :
			{
				GPIO_SetBits(GPIOA,GPIO_Pin_0|GPIO_Pin_1|GPIO_Pin_5|GPIO_Pin_2|
				GPIO_Pin_3|GPIO_Pin_4|GPIO_Pin_6);
		...
		case 9 :
			{
				GPIO_SetBits(GPIOA,GPIO_Pin_5|GPIO_Pin_2|
				GPIO_Pin_3|GPIO_Pin_1|GPIO_Pin_0|GPIO_Pin_6);
